...
func extractSCAIssues(logger *zerolog.Logger, result *EnhancedScanResult, workDir string, _ bool) {
	issues, err := oss.ConvertJSONToIssues(logger, []byte(result.OriginalOutput), nil, workDir)
	if err != nil {
		return
	}
